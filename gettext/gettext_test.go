...
var testTexts = []struct {
	...
	{"default", "github.com/hnakamur/gettext-go/examples/hi.SayHi", "pkg hi: Hello, world!", "pkg hi: Hello, world!"},
	...
	{"zh_CN", "github.com/hnakamur/gettext-go/examples/hi.SayHi", "pkg hi: Hello, world!", "来自\"Hi\"包的问候: 你好, 世界!"},
	...
	{"zh_TW", "github.com/hnakamur/gettext-go/examples/hi.SayHi", "pkg hi: Hello, world!", "來自\"Hi\"包的問候: 你好, 世界!"},
}
